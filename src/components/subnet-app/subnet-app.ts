  ...
  connectedCallback() {
    ...
    this.innerHTML = `
      ...
      <div class="${css.footer}">
        <a class="${css.footerLink}" href="https://andr3w.sh" target="_blank" rel="noopener noreferrer">andr3w.sh</a>
        <a class="${css.githubLink}" href="https://github.com/andrewjamesmoore/visual-subnet" target="_blank" rel="noopener noreferrer">
